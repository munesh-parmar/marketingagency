        ...
        <div className='container'>
            <div className='testimonials-content'>
                <div className='section-t text-center'>
                    ...
                    <p className='text'>Our success story is written in the words of our satisfied customers, Our clients are our best advocates, and their testimonials speak volumes, Don't just take our word for it; listen to what our clients have to say.</p>
                </div>
